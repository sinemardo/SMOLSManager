            ...
            <div style={{ position: 'relative' }}>
              ...
              {menuOpen && (
                <div style={{ position: 'absolute', top: 40, right: 0, background: '#fff', borderRadius: 12, boxShadow: '0 10px 40px rgba(0,0,0,0.15)', padding: 8, minWidth: 200, zIndex: 500 }}>
                  ...
                  <button onClick={() => { onNavigate('shipping'); setMenuOpen(false); }} style={{ display: 'block', width: '100%', padding: '10px 16px', border: 'none', borderRadius: 8, background: 'none', cursor: 'pointer', textAlign: 'left', fontSize: 14, color: '#374151' }}>🚚 Envíos</button>
                  <button onClick={() => { onNavigate('payment'); setMenuOpen(false); }} style={{ display: 'block', width: '100%', padding: '10px 16px', border: 'none', borderRadius: 8, background: 'none', cursor: 'pointer', textAlign: 'left', fontSize: 14, color: '#374151' }}>💳 Pagos</button>
