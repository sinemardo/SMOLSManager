        ...
        {activeTab === 'payment' && (
          <div style={{ background: '#fff', padding: 32, borderRadius: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert('Método de pago guardado correctamente.'); }} style={{ maxWidth: 500 }}>
              <div style={{ display: 'grid', gap: 16 }}>
                <div><label style={{ fontSize: 13, fontWeight: 600, color: '#374151', display: 'block', marginBottom: 4 }}>Titular de la tarjeta</label><input value={payment.name} onChange={e => setPayment({...payment, name: e.target.value})} style={{ width: '100%', padding: '12px', border: '1px solid #e2e8f0', borderRadius: 8, fontSize: 14, boxSizing: 'border-box' }} /></div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  <div><label style={{ fontSize: 13, fontWeight: 600, color: '#374151', display: 'block', marginBottom: 4 }}>Fecha de expiración</label><input value={payment.expiry} onChange={e => setPayment({...payment, expiry: e.target.value})} style={{ width: '100%', padding: '12px', border: '1px solid #e2e8f0', borderRadius: 8, fontSize: 14, boxSizing: 'border-box' }} maxLength={5} /></div>
                ...
                <p style={{ fontSize: 12, color: '#94a3b8', textAlign: 'center' }}>🔒 Tus datos están protegidos.</p>
              </div>
            </form>
          </div>
        )}
